...
public class JsonExtractorShould {
    ...
    @Test
    public void extractSimpleValueFromComplexJson() throws Exception {
    ...
    @Test
    public void shouldMatchNotTrivialPattern() throws Exception {
    ...
    @Test
    public void workWithArrays() throws Exception {
    ...
    @Test
    public void wWorkWithArraysOfSimpleValues() throws Exception {
    ...
    @Test
    public void processMoreThanOnePattern() throws Exception {
